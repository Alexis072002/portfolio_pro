...
export const SideNav: React.FC<SideNavProps> = ({ sections, activeSection }) => {
    return (
        <nav
            role="navigation"
            className="fixed left-6 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-6 py-8 px-3 rounded-full backdrop-blur-3xl bg-black/40 border border-white/5 shadow-[0_0_50px_rgba(0,0,0,1)]"
        >
            {sections.map((id) => {
